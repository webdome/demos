...
function newPic(picElem) {
  ...
  // 裁剪后重新存储
/*  this.storeSize = function() {
    self.verpicwidth = parseFloat(getComputedStyle(self.pic).width);
    self.verpicheight = parseFloat(getComputedStyle(self.pic).height);
    self.horpicwidth = parseFloat(getComputedStyle(self.pic).width);
    self.horpicheight = parseFloat(getComputedStyle(self.pic).height);
    self.width = parseFloat(getComputedStyle(self.box[0]).width);
    self.height = parseFloat(getComputedStyle(self.box[0]).height);
  };*/
  // 右侧水平拽
