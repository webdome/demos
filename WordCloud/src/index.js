...
document.getElementById('button').onclick = function(){
  ...
  if (textarea) {
    keywords = JSON.parse(textarea)
    if (keywords instanceof Object) {
  ...
  createWordCloud(keywords,src)
}
function createWordCloud(keywords,src) {
  ...
  maskImage.src = src || require('./logo.png');
}