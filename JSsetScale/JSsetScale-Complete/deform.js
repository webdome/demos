...
function newBox(elem) {
	...
	if (elem.children().eq(0).attr("class") == "pic") {
		...
		this.ratpicwidth = parseFloat(getComputedStyle(this.pic).width);
		this.ratpicheight = parseFloat(getComputedStyle(this.pic).height);
	}
	...
	self.doDrag1 = function(e) {
		...
		if (self.pic) {
			if (parseFloat(self.box[0].style.width) <= self.verpicwidth) {
				...
				self.img.style.marginTop = -(parseFloat(self.box[0].style.width) - self.verpicwidth) / 2 + "px";
			}
		}
	};
	self.stopDrag1 = function(e) {
		...
		if (self.pic) {
			...
			console.log("horh:" + self.horpicheight + " horw:" + self.horpicwidth + "\n" +
				"verh:" + self.verpicheight + " verw:" + self.verpicwidth + "\n" +
				"mt:" + self.picTop + " ml:" + self.picLeft)
		}
	...
	self.doDrag2 = function(e) {
		...
		if (self.pic) {
			...
			if (parseFloat(self.box[0].style.height) <= self.horpicheight) {
				...
				self.img.style.marginLeft = -(parseFloat(self.box[0].style.height) - self.horpicheight) / 2 + "px";
				self.img.style.marginTop = 0;
			}
		} else {
			self.box[0].style.height = self.height + h + "px";
	...
	self.doDrag01 = function(e) {
		...
		if (self.pic) {
			...
			self.img.style.height = maxheight + change + "px";
			self.img.style.width = maxwidth + change + "px";
		}
	};
